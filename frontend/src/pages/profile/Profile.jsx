...
import { UserCircle, Shield, Mail, Phone, Building2, Lock, CheckCircle2, AlertCircle } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 backdrop-blur-xl">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 border-b border-slate-800 pb-6">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-tr from-indigo-600 to-indigo-400 text-2xl font-bold text-white shadow-glow">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 text-xs">
          <div className="p-3.5 rounded-xl bg-slate-950/60 border border-slate-800/80">
            <span className="text-slate-400 block mb-1">Work Email</span>
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 backdrop-blur-xl">
        ...
        <form onSubmit={handleChangePassword} className="space-y-4 max-w-md">
          ...
          <div>
            <label className="block text-xs font-semibold uppercase text-slate-400 mb-1">New Password (min 6 chars) *</label>
            <input
              type="password"
              required
              value={newPassword}
          ...
          <button
            type="submit"
            disabled={pwdLoading}
            className="rounded-xl bg-indigo-600 px-5 py-2.5 text-xs font-semibold text-white shadow-lg shadow-indigo-600/25 hover:bg-indigo-500 transition-all disabled:opacity-50"
          >
